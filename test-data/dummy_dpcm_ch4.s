...
dummy_dpcm_music_data:
	...
	.word @instruments
	.word @samples-3
	.word @song0ch0,@song0ch1,@song0ch2,@song0ch3,0,307,256
	.word @song1ch0,@song1ch1,@song1ch2,@song1ch3,0,307,256
...
@song0ch1loop:
@ref1:
	.byte $91,$82,$46,$46,$46,$44,$44,$45,$00,$dd
	.byte $fd
	.word @song0ch1loop
...
@song1ch1loop:
@ref5:
	.byte $85,$82,$34,$38,$34,$38,$99,$00,$d5
	.byte $fd
	.word @song1ch1loop
...
@song1ch2loop:
@ref6:
	.byte $83,$80,$34,$38,$34,$38,$38,$34,$38,$34,$34,$38,$8f,$00,$d5
	.byte $fd
	.word @song1ch2loop
...
@song1ch3loop:
@ref7:
	.byte $89,$82,$0a,$0e,$0a,$0e,$0e,$93,$00,$d5
	.byte $fd
	.word @song1ch3loop
