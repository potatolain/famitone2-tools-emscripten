...
dummy_dpcm_music_data:
	...
	dw @instruments
	dw @samples-3
	dw @song0ch0,@song0ch1,@song0ch2,@song0ch3,0,307,256
	dw @song1ch0,@song1ch1,@song1ch2,@song1ch3,0,307,256
...
@song0ch0loop:
@ref0:
	db $82,$4c,$4c,$4c,$4c,$4c,$4c,$4c,$91,$00,$dd
	db $fd
	dw @song0ch0loop
...
@song0ch1loop:
@ref1:
	db $91,$82,$46,$46,$46,$44,$44,$45,$00,$dd
	db $fd
	dw @song0ch1loop
